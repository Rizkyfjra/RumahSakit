    ...
    public function publishAssets() {
        ...
        if (is_dir($assets)) {
            ...
            if($this->imageProcessing){
                ...
                Yii::app() -> clientScript -> registerScriptFile($baseUrl . '/js/jquery.fileupload-ap.js', CClientScript::POS_END);
                Yii::app() -> clientScript -> registerScriptFile($baseUrl . '/js/jquery.fileupload-vp.js', CClientScript::POS_END);
            }
