 ...
 */
class ExamStudentlist extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('id, room_id, no_room', 'student_id', 'class_id', 'on'=>'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
           'detail'=>array(SELF::BELONGS_TO, 'ExamRoom', 'room_id'),
        );
    }
