            ...
            <div class="row">
              ...
              <?php } ?>
                <div class="form-group">
                  ...
                  <?php echo $form->textField($model,'repeat_quiz',array('class'=>'form-control input-pn input-lg','placeholder'=>'Contoh: 1','readonly'=>true)); ?>
                </div>
              </div> 
              <?php if(!$model->isNewRecord){ ?>
              <div class="col-md-2">
                ...
                <div class="form-group">
                  ...
                  <div class="btn-group btn-group-justified" data-toggle="buttons">
                    <label class="btn btn-info btn-lg <?php echo '',$tipe == 0 ? "active" : "" ?>">
                      <input type="radio" name="Quiz[quiz_type]" id="Quiz_type_1" autocomplete="off" value="0" <?php echo '',$tipe == 0 ? "checked" : "" ?>> PH
                    </label>
                    <label class="btn btn-info btn-lg <?php echo '',$tipe == 1 ? "active" : "" ?>">
                      <input type="radio" name="Quiz[quiz_type]" id="Quiz_type_2" autocomplete="off" value="1" <?php echo '',$tipe == 1 ? "checked" : "" ?>> PTS
                    </label>
                    <label class="btn btn-info btn-lg <?php echo '',$tipe == 2 ? "active" : "" ?>">
                      <input type="radio" name="Quiz[quiz_type]" id="Quiz_type_3" autocomplete="off" value="2" <?php echo '',$tipe == 2 ? "checked" : "" ?>> PAS
                    </label>
                    <?php if($online) { ?>
                      <label class="btn btn-info btn-lg <?php echo '',$tipe == 4 ? "active" : "" ?>">
                      <input type="radio" name="Quiz[quiz_type]" id="Quiz_type_1" autocomplete="off" value="4" <?php echo '',$tipe == 4 ? "checked" : "" ?>> PTS-B
                      </label>
                      <label class="btn btn-info btn-lg <?php echo '',$tipe == 5 ? "active" : "" ?>">
                       <input type="radio" name="Quiz[quiz_type]" id="Quiz_type_2" autocomplete="off" value="5" <?php echo '',$tipe == 5 ? "checked" : "" ?>> PAS-B
                      </label>
                      <label class="btn btn-info btn-lg <?php echo '',$tipe == 6 ? "active" : "" ?>">
                       <input type="radio" name="Quiz[quiz_type]" id="Quiz_type_3" autocomplete="off" value="6" <?php echo '',$tipe == 6 ? "checked" : "" ?>> US-B
                      </label>
                    <?php } ?>
                  </div>
                </div>
