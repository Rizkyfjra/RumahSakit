...
var passcode="<?php echo md5($passcode) ?>";$("#kode").change(function(){kode=$("#kode").val(),kode=CryptoJS.MD5(kode),kode==passcode?(localStorage.setItem("status","0"),window.location.href="<?php echo Yii::app()->baseUrl ?>/quiz/startQuiz/<?php echo $model->id;?>"):alert("passcode salah!")});
</script>
