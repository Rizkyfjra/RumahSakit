...
<div class="col-md-12">
  <div id="bc1" class="btn-group btn-breadcrumb">
	...
	<?php echo CHtml::link('<div>Nilai Pengetahuan</div>',array('#'), array('class'=>'btn btn-success')); ?>
  </div>
</div>
<br/>
			...
			<table class="table table-bordered table-hovered well table-responsive">
				<tbody>
					<tr>
						<th>No</th>
						<th>Nama Siswa</th>
						<th class="danger">NUH 1</th>
						<th class="danger">NUH 2</th>
						<th class="danger">NUH 3</th>
						<th class="danger">NUH 4</th>
						<th class="danger">NUH 5</th>
						<th class="danger">NUH 6</th>
						<th class="danger">NUH 7</th>
						<th>Nilai Pen</th>
						...
						<tr>
							...
							<td>
								<?php 
									...
									if (!empty($nilai_arr[$sw->id]['nilai-kd1'])) {
							...
							<td>
								<?php 
									...
									if (!empty($nilai_arr[$sw->id]['nilai-kd2'])) {
							...
							<td>
								<?php 
									...
									if (!empty($nilai_arr[$sw->id]['nilai-kd3'])) {
							...
							<td>
								<?php 
									...
									if (!empty($nilai_arr[$sw->id]['nilai-kd4'])) {
							...
							<td>
								<?php 
									...
									if (!empty($nilai_arr[$sw->id]['nilai-kd5'])) {
							...
							<td>
								<?php 
									...
									if (!empty($nilai_arr[$sw->id]['nilai-kd6'])) {
							...
							<td>
								<?php 
									...
									if (!empty($nilai_arr[$sw->id]['nilai-kd7'])) {
							...
							<?php
								...
								if (!empty($nilai_arr[$sw->id]['desc-desc_pengetahuan'])) {
										echo "<td>";	
										echo $nilai_arr[$sw->id]['desc-desc_pengetahuan'];
										echo "</td>";
									} 
