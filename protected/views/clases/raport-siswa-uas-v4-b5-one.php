...
<!-- 	<sub>
	...
	<table border="5" style="width:100%;border: 2px solid black;">
			...
			if(!empty($peluas1)){
				foreach ($peluas1 as $key => $rowpeluas1) {
					...
					if (strpos(strtolower($nama_kelas),'xii ')!==false ) {
						if ( $rowpeluas1['name'] =='Bahasa Inggris'  or $rowpeluas1['name'] =='Lintas Minat Bahasa Inggris') {
							$kkm = 78;
						} elseif ( $rowpeluas1['name'] =='Ekonomi'  or $rowpeluas1['name'] =='Lintas Minat Ekonomi' ) {
							$kkm = 79;
						}  else {
							$kkm = 80;
						}
						...
						if ( $rowpeluas1['name'] =='Bahasa Inggris'  or $rowpeluas1['name'] =='Lintas Minat Bahasa Inggris' ) {
							$kkm = 76;
						} elseif ( $rowpeluas1['name'] =='Ekonomi' ) {
							$kkm = 77;
						}   else {
							$kkm = 78;
						}
					} elseif (strpos(strtolower($nama_kelas),'x ')!==false ) {
						if ( $rowpeluas1['name'] =='Sejarah Indonesia' or $rowpeluas1['name'] =='Seni Budaya' or $rowpeluas1['name'] =='Kimia' or $rowpeluas1['name'] =='Sejarah'  or $rowpeluas1['name'] =='Lintas Minat Bahasa Jepang' ) {
							$kkm = 75;
						} elseif ( $rowpeluas1['name'] =='Lintas Minat Ekonomi' ) {
							$kkm = 74;
						} else {
							$kkm = 70;
						}
		...
		?>
		<tr>
			<td colspan="6"><b>Kelompok C (Peminatan)</b></td>
		</tr>
		<?php
			$no = 1;
			if(!empty($peluas1)){
			...
			<td width="30%">
				<p class="text-center">
					...
					if(Yii::app()->session['titimangsa']){
						...
						echo(DateToIndo(date('2017-12-16')));
					}
					?>
					<br/>
					Wali Kelas
					...
					<b>
							<?php 
						if(Yii::app()->session['walikelas']){
							echo Yii::app()->session['walikelas'];
						}else {
					...
					<b>NIP.
							<?php 
						if(Yii::app()->session['nipwali']){
							echo Yii::app()->session['nipwali'];
						}else {
							if(!empty($model->teacher_id)){
			...
			<?php }else{ ?>
				...
				<td align="left">
					...
					if (!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="A") {
						echo "Sangat terampil dalam mempraktikan tentang ".implode(", ", $rowpeluas1['nilai-kddescription-ket'])."";
					} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="B"){
						echo "Terampil dalam mempraktikan tentang ".implode(", ", $rowpeluas1['nilai-kddescription-ket'])."";
					} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="C"){
						echo "Cukup terampil dalam mempraktikan tentang ".implode(", ", $rowpeluas1['nilai-kddescription-ket'])."";
					} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="D"){
						echo "Kurang terampil dalam mempraktikan tentang".implode(", ", $rowpeluas1['nilai-kddescription-ket'])."";
					}?>
				</td>
				<?php } else {?>
				<td align="left"><?php 
...
<!-- 	<sub>
	...
	<p>
		...
		?>
				...
				<?php if (strpos(strtolower($nama_kelas),'xii ')!==false ) { ?>		
				...
				<table border="5" style="width:100%;border: 2px solid black;">
					...
					<tr valign="center">
						...
						<?php
							$rentang = Clases::model()->rentang(78); 
							$rentang_a = $rentang[0];
							$rentang_b = $rentang[1];
							$rentang_c = $rentang[2];
							$rentang_d = $rentang[3];
					...
					<tr>
						...
						<?php
							$rentang = Clases::model()->rentang(79); 
							$rentang_a = $rentang[0];
							$rentang_b = $rentang[1];
							$rentang_c = $rentang[2];
							$rentang_d = $rentang[3];
					...
					<tr>
						...
						<?php
							$rentang = Clases::model()->rentang(80); 
							$rentang_a = $rentang[0];
							$rentang_b = $rentang[1];
							$rentang_c = $rentang[2];
							$rentang_d = $rentang[3];
				...
				<?php } elseif (strpos(strtolower($nama_kelas),'xi ')!==false ) { ?>
				<b>Tabel Interval Predikat</b>
				<table border="5" style="width:100%;border: 2px solid black;">
					<tr valign="center">
						<th rowspan="2" align="center">KKM</th>
					...
					<tr valign="center">
						...
						<?php
							$rentang = Clases::model()->rentang(76); 
							$rentang_a = $rentang[0];
							$rentang_b = $rentang[1];
							$rentang_c = $rentang[2];
							$rentang_d = $rentang[3];
					...
					<tr>
						...
						<?php
							$rentang = Clases::model()->rentang(77); 
							$rentang_a = $rentang[0];
							$rentang_b = $rentang[1];
							$rentang_c = $rentang[2];
							$rentang_d = $rentang[3];
				...
				<?php } elseif (strpos(strtolower($nama_kelas),'x ')!==false ) { ?>
				...
				<table border="5" style="width:100%;border: 2px solid black;">
					...
					<tr valign="center">
						...
						<?php
							$rentang = Clases::model()->rentang(70); 
							$rentang_a = $rentang[0];
							$rentang_b = $rentang[1];
							$rentang_c = $rentang[2];
							$rentang_d = $rentang[3];
					...
					<tr>
						...
						<?php
							$rentang = Clases::model()->rentang(74); 
							$rentang_a = $rentang[0];
							$rentang_b = $rentang[1];
							$rentang_c = $rentang[2];
							$rentang_d = $rentang[3];
					...
					<tr>
						...
						<?php
							$rentang = Clases::model()->rentang(75); 
							$rentang_a = $rentang[0];
							$rentang_b = $rentang[1];
							$rentang_c = $rentang[2];
							$rentang_d = $rentang[3];
...
<!-- Halaman 5 -->
<?php if($semester=="2") { ?>
	<?php if(strpos(strtolower($nama_kelas),'12 ')!==false || strpos(strtolower($nama_kelas),'xii ')) { ?>
<section id="typography" style="margin-top:10px;">
	<center><h5>KETERANGAN PINDAH SEKOLAH</h5></center>
	<table>
		<tr>
	...
	<table border="5" style="width:100%;border: 2px solid black;">
		...
		<tr>
			<th>Tanggal</th>
			<th>Kelas yang Ditinggalakan</th>
			<th>Sebab-sebab Keluar atau Atas Permintaan (Tertulis)</th>
			<th>Tanda Tangan Kepala Sekolah, dan Tangan Tangan Orang Tua/Wali</th>
		</tr>
		<tr>
			<td align="center">
				<?php 
			...
			<td align="center">
				<?php if( $tahun_ajaran != $tahun_ajaran_db[0]->value ) {
						$kelasnya = ClassHistory::model()->findAll(array('condition'=>'user_id = "'.$siswa->id.'" AND year = "'.$tahun_ajaran.'"')); 
