...
<!-- 	<sub>
	...
	<ol type="A">
		...
		<b><li>
			...
			<table border="5" style="width:100%;border: 2px solid black;">
				<tr>
					<th height="20px" rowspan="2" align="center" width="5%">No.</th>
					<th height="20px" rowspan="2" align="center" width="30%">Mata Pelajaran</th>
					<th height="20px" rowspan="2" width="10%">KKM</th>
					<th height="20px" colspan="2" align="center">Pengetahuan</th>
					<th height="20px" colspan="2" align="center">Keterampilan</th>
				</tr>
				<tr>
					<th height="20px" width="10%" align="center">Nilai</th>
					<th height="20px" align="center">Predikat</th>
					<th height="20px" width="10%" align="center">Nilai</th>
					<th height="20px" align="center">Predikat</th>
				</tr>
				<tr>
				...
				?>
				<tr>
					<td height="35px" align="center"><?php echo $no; ?></td>
					<td height="35px"><?php echo $rowpeluas1['name']; ?></td>
					<td height="35px" align="center"><?php echo $kkm;?></td>
					<?php if(!empty($rowpeluas1['nilai-pengetahuan']) && $rowpeluas1['nilai-pengetahuan']!="-") { ?>
						<td height="35px" align="center"><?php echo $rowpeluas1['nilai-pengetahuan']; ?></td>
					<?php }else{ ?>
						<td height="35px" align="center">-</td>
					<?php } ?>
					<?php if(!empty($rowpeluas1['p-np']) && $rowpeluas1['p-np']!="-") { ?>
						<td height="35px" align="center"><?php echo $rowpeluas1['p-np']; ?></td>
					<?php }else{ ?>
						<td height="35px" align="center">-</td>
					<?php } ?>
					<?php if(!empty($rowpeluas1['nilai-keterampilan']) && $rowpeluas1['nilai-keterampilan']!="-") { ?>
						<td height="35px" align="center"><?php echo $rowpeluas1['nilai-keterampilan']; ?></td>
					<?php }else{ ?>
						<td height="35px" align="center">-</td>
					<?php } ?>
					<?php if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']!="-") { ?>
						<td height="35px" align="center"><?php echo $rowpeluas1['p-nk']; ?></td>
					<?php }else{ ?>
						<td height="35px" align="center">-</td>
					<?php } ?>
				</tr>
				...
				?>
				<tr>
					<td height="35px" colspan="7"><b>Kelompok B (Umum)</b></td>
				</tr>
				<?php
					$no = 1;
					if(!empty($peluas1)){
				...
				?>
				<tr>
					<td height="35px" colspan="7"><b>Kelompok C (Peminatan)</b></td>
				</tr>
				<?php
					$no = 1;
					if(!empty($peluas1)){
...
<!-- Halaman 3 -->
<section id="typography" class="break-before" style="margin-top:10px;">
<!-- 	<sub>
		Hal 4
	</sub> -->
	<hr style="width:100%;border: 1px solid black;"/>
					...
					<tr>
						<td width="100%" colspan="2">
							<p class="text-center">
								...
								<br>
								<br>
								<img style="margin-bottom: 5px; margin-top: 9px;" src="<?php echo Yii::app()->getBaseUrl(); ?>/images/<?php echo $nik; ?>.jpg" width="175px" height="100px">	
								<br>
								<br>
								<br>
								<b><?php echo $kepsek;?></b>
