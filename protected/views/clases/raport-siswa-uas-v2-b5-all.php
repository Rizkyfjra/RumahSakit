...
<!-- 	<sub>
	...
	<table border="0" style="width:100%;">
		...
		<tr >
			<td>Nama</td>
			<td> : <?php echo ucwords(strtolower($siswa[$z]->display_name));?></td>
	...
	<table border="5" style="width:100%;border: 2px solid black;">
		...
		<tr valign="top">
			...
			<?php }else{ ?>
								...
								<td height="40px" valign="middle">Selalu bersyukur dan berdo'a sebelum melakukan kegiatan serta memiliki toleran pada agama yang berbeda, ketaatan beribadah sudah menjadi pembiasaan.</td>
								<?php } else {?>
								<td height="40px" valign="middle">Bersyukur dan berdo'a sebelum melakukan kegiatan serta memiliki toleran pada agama yang berbeda, ketaatan beribadah masih harus ditingkatkan.</td>
								<?php }?>
			<?php } ?>
		</tr>
	</table>
	...
	<table border="5" style="width:100%;border: 2px solid black;">
		...
		<tr valign="top">
			...
			<?php }else{ ?>
								...
								<td height="40px" valign="middle">Memiliki sikap santun, displin dan tanggung jawab yang sangat baik, sikap kepedulian sudah meningkat.</td>
								<?php } else {?>
								<td height="40px" valign="middle">Memiliki sikap santun, displin dan tanggung jawab yang baik, sikap kepedulian perlu ditingkatkan.</td>
								<?php }?>
			<?php } ?>
		</tr>
	</table>
