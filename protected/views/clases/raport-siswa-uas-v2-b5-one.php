...
<?php
	...
	function DateToIndo($date) {
		$BulanIndo = array("Januari", "Februari", "Maret",
						...
						"Oktober", "November", "ncurses_def_shell_mode(oid)ber");
		...
		<tr valign="top">
			...
			<?php }else{ ?>
								<?php if(!empty($peluas2['Sikap Spiritual - Predikat'])) { ?>
									...
									<td height="45px" valign="middle">Kebiasaan berdoa dan memberi salam sebelum dan sesudah melakukan kegiatan pembelajaran, menghormati orang lain dalam melaksanakan ibadah telah dilaksanakan dengan sangat baik.</td>
									<?php } else {?>
									<td height="45px" valign="middle">Kebiasaan berdoa dan memberi salam sebelum dan sesudah melakukan kegiatan pembelajaran, menghormati orang lain dalam melaksanakan ibadah telah dilaksanakan dengan baik.</td>
									<?php }?>
								<?php } else {?>
								<td height="45px" valign="middle">-</td>
								<?php }?>
			<?php } ?>
		</tr>
	</table>
		...
		<tr valign="top">
			...
			<?php }else{ ?>
								<?php if(!empty($peluas2['Sikap Sosial - Predikat'])) { ?>
									...
									<td height="45px" valign="middle">Memiliki sikap perilaku jujur, disiplin dalam belajar, peduli terhadap teman, santun dalam ucapan dan tidakan, responsif, pro-aktif dan penunjukan sikap dengan sangat baik.</td>
									<?php } else {?>
									<td height="45px" valign="middle">Memiliki sikap perilaku jujur, disiplin dalam belajar, peduli terhadap teman, santun dalam ucapan dan tidakan, responsif, pro-aktif dan penunjukan sikap dengan baik.</td>
									<?php }?>
								<?php } else {?>
								<td height="45px" valign="middle">-</td>
								<?php }?>
					...
					if(!empty($rowpeluas1['nilai-pengetahuan']) && !empty($rowpeluas1['nilai-keterampilan'])){
						if(!empty($rowpeluas1['nilai-pengetahuan'])){
							if($rowpeluas1['nilai-pengetahuan']<75){
								$rowpeluas1['p-np'] = "D";
							}elseif($rowpeluas1['nilai-pengetahuan']>=75 && $rowpeluas1['nilai-pengetahuan']<79){
								$rowpeluas1['p-np'] = "C";
							}elseif($rowpeluas1['nilai-pengetahuan']>=79 && $rowpeluas1['nilai-pengetahuan']<90){
								$rowpeluas1['p-np'] = "B";
					 ...
					 if(!empty($rowpeluas1['nilai-keterampilan'])){
							if($rowpeluas1['nilai-keterampilan']<75){
								$rowpeluas1['p-nk'] = "D";
							}elseif($rowpeluas1['nilai-keterampilan']>=75 && $rowpeluas1['nilai-keterampilan']<79){
								$rowpeluas1['p-nk'] = "C";
							}elseif($rowpeluas1['nilai-keterampilan']>=79 && $rowpeluas1['nilai-keterampilan']<90){
								$rowpeluas1['p-nk'] = "B";
					...
					<?php if(!empty($rowpeluas1['nilai-kddescription']) && $rowpeluas1['nilai-kddescription']!="-") { ?>
						<td align="left">
							...
							if (!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="A") {
								echo "Sangat terampil ".implode(", ", $rowpeluas1['nilai-kddescription'])."";
							} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="B"){
								echo "Terampil ".implode(", ", $rowpeluas1['nilai-kddescription'])."";
							} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="C"){
								echo "Cukup terampil ".implode(", ", $rowpeluas1['nilai-kddescription'])."";
							} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="D"){
								echo "Kurang terampil ".implode(", ", $rowpeluas1['nilai-kddescription'])."";
							}?>
						</td>
						<?php } else {?>
						<td align="left"><?php 
