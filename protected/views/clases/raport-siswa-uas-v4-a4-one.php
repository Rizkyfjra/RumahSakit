		...
		<tr>
			<td width="100%" colspan="2">
				<p class="text-center">
					Kepala Sekolah
					<br>
					<?php if ($nik == "196001071987031007"){?>
					<img style="margin-bottom: -52px; margin-top: 9px;" src="<?php echo Yii::app()->getBaseUrl(); ?>/images/<?php echo $nik; ?>.jpg" width="175px" height="100px">	
					<?php } else { ?>
					<img style="margin-bottom: -33px; margin-top: 9px; width: 22%;" src="<?php echo Yii::app()->getBaseUrl(); ?>/images/<?php echo $nik; ?>.jpg" width="175px" height="100px">	
					<?php }?>
					<br>
					<b><?php echo $kepsek;?></b>
					<br>
