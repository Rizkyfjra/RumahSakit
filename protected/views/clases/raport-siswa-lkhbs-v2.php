...
<section id="typography" class="break-after" style="margin-top:10px;">		
	<table border="0" style="width:100%;">
		<tr>
			...
			<td><h3 style="margin: 0px;">SEKOLAH MENENGAH PERTAMA</h3>
			<h3 style="margin-top: -13px; margin-bottom: 0px;">DARUL HIKAM </h3>
    <h4 style="margin: 0px;" >LAPORAN KEMAJUAN HASIL BELAJAR SISWA BULAN JULI</h4></td>
		</tr>
		<tr>
				...
				foreach ($peluas1 as $key => $rowpeluas1) {
					if(!empty($rowpeluas1['nilai-kd1'])){
						if(!empty($rowpeluas1['nilai-kddescription'])){
							$rowpeluas1['p-np']  = terbilang($rowpeluas1['nilai-kd1']);
						}
						if(!empty($rowpeluas1['nilai-kddescription-ket'])){
							$rowpeluas1['p-nk'] = terbilang($rowpeluas1['nilai-keterampilan']);
						}

						if($rowpeluas1['kelompok']!=4){
		?>
		<tr>
			<td align="center" rowspan="2" style="padding-top:2px;padding-bottom:2px;"><?php echo $no; ?></td>
...
<section id="typography" class="break-after" style="margin-top:10px;">		
	...
	<table border="0" style="width:100%;border: 0px solid black;margin-top: 0.5px;margin-bottom: 0.5px;">
		<tr>
			...
			<td width="30%">
				<p class="text-center">
					Bandung, <?php echo(DateToIndo(date('2018-02-20')));?><br/>
					Wali Kelas
					<br>
...
<section id="typography" class="break-after" style="margin-top:10px;">		
	...
	<table border="5" style="width:100%;border: 2px solid black;">
		<tr>
			...
			<th align="center" width="20%">Pelajaran</th>
			<th align="center" width="10%">Aspek Penilaian</th>
		...
		<?php
			...
			if(!empty($peluas1)){
				foreach ($peluas1 as $key => $rowpeluas1) {
					if(!empty($rowpeluas1['nilai-kd1']) or !empty($rowpeluas1['nilai-kd1_ket'])){
						if(!empty($rowpeluas1['nilai-kd1'])){
						...
						if(!empty($rowpeluas1['nilai-kd1_ket'])){
							if($rowpeluas1['nilai-kd1_ket']<75){
								$rowpeluas1['p-nk'] = "D";
								$peluas1[$key]['p-nk'] = "D";
							}elseif($rowpeluas1['nilai-kd1_ket']>=75 && $rowpeluas1['nilai-kd1_ket']<84){
								$rowpeluas1['p-nk'] = "C";
								$peluas1[$key]['p-nk'] = "C";
							}elseif($rowpeluas1['nilai-kd1_ket']>=84 && $rowpeluas1['nilai-kd1_ket']<93){
								$rowpeluas1['p-nk'] = "B";
								$peluas1[$key]['p-nk'] = "B";
							}elseif($rowpeluas1['nilai-kd1_ket']>=93 && $rowpeluas1['nilai-kd1_ket']<=100){
								$rowpeluas1['p-nk'] = "A";
								$peluas1[$key]['p-nk'] = "A";
							}else{
								$rowpeluas1['p-nk'] = "-";
						...
						if($rowpeluas1['kelompok']!=5){
		?>
		
		<?php if((!empty($rowpeluas1['p-np']) && $rowpeluas1['p-np']!="-") or (!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']!="-")) { ?>
		<tr>
			<td rowspan="2" align="center" style="padding-top:2px;padding-bottom:2px;"><?php echo $no; ?></td>
			<td rowspan="2" ><?php echo $rowpeluas1['name']; ?></td>
