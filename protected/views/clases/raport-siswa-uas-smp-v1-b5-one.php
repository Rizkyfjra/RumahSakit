...
<?php
	...
	if( $tahun_ajaran != $tahun_ajaran_db[0]->value ) {
	 ...
	 if ($optSchoolType == "SMA NEGERI 1 BANDUNG" || $optSchoolType == "SMA NEGERI 2 BANDUNG") {
		 $kkm = 75;
	} else if($optSchoolType=="SMP NEGERI 43 BANDUNG"){
		$kkm = 65;
	} else {
			...
			<?php }else{ ?>
								<?php if(!empty($peluas2['Sikap Spiritual - Predikat'])) { ?>
									<?php if($peluas2['Sikap Spiritual - Predikat']  == "A" || $peluas2['Sikap Spiritual - Predikat']  == "SB" ) { ?>
										<?php if ( $optSchoolType == "SMA NEGERI 2 BANDUNG" || $optSchoolType == "SMA Negeri 2 Bandung") { ?>
										...
										<?php }  else {?>
										<td height="40px" valign="middle">Kebiasaan berdoa dan memberi salam sebelum dan sesudah melakukan kegiatan pembelajaran, menghormati orang lain dalam melaksanakan ibadah telah dilaksanakan dengan sangat baik.</td>
										<?php }?>
									<?php } else {?>
										<?php if ( $optSchoolType == "SMA NEGERI 2 BANDUNG" || $optSchoolType == "SMA Negeri 2 Bandung") { ?>
										...
										<?php }  else {?>
										<td height="40px" valign="middle">Kebiasaan berdoa dan memberi salam sebelum dan sesudah melakukan kegiatan pembelajaran, menghormati orang lain dalam melaksanakan ibadah telah dilaksanakan dengan baik.</td>
										<?php }?>
									<?php }?>
								<?php } else {?>
	...
	<table border="5" style="width:100%;border: 2px solid black;">
		...
		<tr valign="top">
			<?php if(!empty($peluas2['Sikap Sosial - Predikat']) && $peluas2['Sikap Sosial - Predikat']!="-") { ?>
				<td height="40px" align="center" valign="middle"><b><?php echo $peluas2['Sikap Sosial - Predikat']; ?></b></td>
			<?php }else{ ?>
				<td height="40px" align="center" valign="middle">-</td>
			<?php } ?>
			<?php if(!empty($peluas2['Sikap Sosial - Deskripsi']) && $peluas2['Sikap Sosial - Deskripsi']!="-") { ?>
				<td height="40px" valign="middle"><?php echo $peluas2['Sikap Sosial - Deskripsi']; ?></td>
			<?php }else{ ?>
			...
			<?php }else{ ?>
				...
				<td align="left">
					...
					if (!empty($rowpeluas1['p-np']) && $rowpeluas1['p-np']=="A") {
						echo "Ananda ".$siswa->display_name." memahami pengetahuan tentang  ".implode(", ", $rowpeluas1['nilai-kddescription'])." dengan sangat baik";
			...
			<?php }else{ ?>
				...
				<td align="left">
					...
					if (!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="A") {
						echo "Sangat terampil dalam mempraktikan tentang ".implode(", ", $rowpeluas1['nilai-kddescription'])."";
					} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="B"){
						echo "Terampil dalam mempraktikan tentang ".implode(", ", $rowpeluas1['nilai-kddescription'])."";
					} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="C"){
						echo "Cukup terampil dalam mempraktikan tentang ".implode(", ", $rowpeluas1['nilai-kddescription'])."";
					} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="D"){
						echo "Kurang terampil dalam mempraktikan tentang".implode(", ", $rowpeluas1['nilai-kddescription'])."";
					}?>
				</td>
				<?php } else {?>
				<td align="left"><?php 
			...
			<td align="center">
				Bandung, <?php 
					if(Yii::app()->session['titimangsa']){
						...
						echo(DateToIndo(date('2018-06-08')));
					}
					?>
					<br>
					Kepala Sekolah
