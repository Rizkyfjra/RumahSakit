			...
			<table border="5" style="width:100%;border: 2px solid black;">
				...
				<tr valign="top">
					<?php if(!empty($peluas2[$z]['Sikap Spiritual - Predikat']) && $peluas2[$z]['Sikap Spiritual - Predikat']!="-") { ?>
						<td height="50px" align="center" valign="middle"><b><?php echo $peluas2[$z]['Sikap Spiritual - Predikat']; ?></b></td>
					<?php }else{ ?>
						<td height="50px" align="center" valign="middle">-</td>
					<?php } ?>
					<?php if(!empty($peluas2[$z]['Sikap Spiritual - Deskripsi']) && $peluas2[$z]['Sikap Spiritual - Deskripsi']!="-") { ?>
						<td height="50px" valign="middle"><?php echo $peluas2[$z]['Sikap Spiritual - Deskripsi']; ?></td>
					<?php }else{ ?>
						<td height="50px" align="center" valign="middle">-</td>
					<?php } ?>
				</tr>
			...
			<table border="5" style="width:100%;border: 2px solid black;">
				...
				<tr valign="top">
					<?php if(!empty($peluas2[$z]['Sikap Sosial - Predikat']) && $peluas2[$z]['Sikap Sosial - Predikat']!="-") { ?>
						<td height="50px" align="center" valign="middle"><b><?php echo $peluas2[$z]['Sikap Sosial - Predikat']; ?></b></td>
					<?php }else{ ?>
						<td height="50px" align="center" valign="middle">-</td>
					<?php } ?>
					<?php if(!empty($peluas2[$z]['Sikap Sosial - Deskripsi']) && $peluas2[$z]['Sikap Sosial - Deskripsi']!="-") { ?>
						<td height="50px" valign="middle"><?php echo $peluas2[$z]['Sikap Sosial - Deskripsi']; ?></td>
					<?php }else{ ?>
						<td height="50px" align="center" valign="middle">-</td>
					<?php } ?>
				</tr>
						...
						foreach ($peluas1[$z] as $rowpeluas1) {
							if(!empty($rowpeluas1['nilai-pengetahuan']) && !empty($rowpeluas1['nilai-keterampilan'])){
								if(!empty($rowpeluas1['nilai-pengetahuan'])){
									if($rowpeluas1['nilai-pengetahuan']<78){
										$rowpeluas1['p-np'] = "D";
									}elseif($rowpeluas1['nilai-pengetahuan']>=78 && $rowpeluas1['nilai-pengetahuan']<81){
										$rowpeluas1['p-np'] = "C";
									}elseif($rowpeluas1['nilai-pengetahuan']>=81 && $rowpeluas1['nilai-pengetahuan']<91){
										$rowpeluas1['p-np'] = "B";
								...
								if(!empty($rowpeluas1['nilai-keterampilan'])){
									if($rowpeluas1['nilai-keterampilan']<78){
										$rowpeluas1['p-nk'] = "D";
									}elseif($rowpeluas1['nilai-keterampilan']>=78 && $rowpeluas1['nilai-keterampilan']<81){
										$rowpeluas1['p-nk'] = "C";
									}elseif($rowpeluas1['nilai-keterampilan']>=81 && $rowpeluas1['nilai-keterampilan']<91){
										$rowpeluas1['p-nk'] = "B";
	...
	<ol type="A" start="2">
		<b><li style="list-style:none">
			<table border="5" style="width:100%;border: 2px solid black;">
				...
				<tr>
					<td rowspan="2" align="center"><?php echo $no; ?></td>
					<?php if(!empty($rowpeluas1['name'])){ ?>
						<td rowspan="2"><?php echo $rowpeluas1['name']; ?></td>
					<?php }else{ ?>
						<td>-</td>
					<?php } ?>
					<td align="center">Pengetahuan</td>
					<?php if(!empty($rowpeluas1['desc-desc_pengetahuan'])) { ?>
						<td><?php echo $rowpeluas1['desc-desc_pengetahuan']; ?></td>
					<?php }else{ ?>
						<td align="center">-</td>
					<?php } ?>
				...
				<tr>
					<td align="center">Keterampilan</td>
					<?php if(!empty($rowpeluas1['desc-desc_keterampilan'])) { ?>
						<td><?php echo $rowpeluas1['desc-desc_keterampilan']; ?></td>
					<?php }else{ ?>
						<td align="center">-</td>
					<?php } ?>
