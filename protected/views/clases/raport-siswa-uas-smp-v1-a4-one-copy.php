		...
		<b><li>
			...
			<?php }else{ ?>
				...
				<td align="left">
					...
					// 	echo "Kemampuan dalam memahami, menerapkan, menganalisis pengetahuan tentang  ".implode(",", $rowpeluas1['nilai-kddescription'])." dengan Sangat Baik";
					// } else if(!empty($rowpeluas1['p-np']) && $rowpeluas1['p-np']=="B"){
					// 	echo "Kemampuan dalam memahami, menerapkan, menganalisis pengetahuan tentang  ".implode(",", $rowpeluas1['nilai-kddescription'])." dengan Baik";
					// } else if(!empty($rowpeluas1['p-np']) && $rowpeluas1['p-np']=="C"){
					// 	echo "Kemampuan dalam memahami, menerapkan, menganalisis pengetahuan tentang  ".implode(",", $rowpeluas1['nilai-kddescription'])." dengan Cukup Baik";
					// } else if(!empty($rowpeluas1['p-np']) && $rowpeluas1['p-np']=="D"){
					// 	echo "Kemampuan dalam memahami, menerapkan, menganalisis pengetahuan tentang  ".implode(",", $rowpeluas1['nilai-kddescription'])." perlu ditingkatkan";
					// }
					?>
				</td>
				<?php } else { ?>
			...
			<table border="0" style="width:100%;border: 0px solid black;margin-top: 0.5px;margin-bottom: 0.5px;">
				<tr>
					...
					if(Yii::app()->session['titimangsa']){
						...
						if ($optSchoolType=="SMP NEGERI 43 BANDUNG") {
							echo(DateToIndo(date('2018-12-04')));
						}	else {
							echo(DateToIndo(date('2018-12-04')));
						}
						// echo(DateToIndo(date('2018-12-04')));
