...
<section id="typography" class="break-after" style="margin-top:10px;">		
	<table border="0" style="width:100%;">
		<tr>
			...
			<td align="center"><h3 style="margin: 0px;">LAPORAN PENILAIAN TENGAH SEMESTER GANJIL</h3>
    <h4 style="margin: 0px;" >SEKOLAH MENENGAH PERTAMA DARUL HIKAM</h4></td>
		</tr>
		<tr>
			<td align="center" ><?php echo $alamat_sekolah[0]->value; ?></td>
		</tr>
		<tr >
			<td align="center">Telp. 022-2501375 Fax. 022-2501375</td>
		</tr>
		<tr>
			<td align="center" >Website: www.smpdarulhikam.sch.id Email: smp@darulhikam.com</td>
		</tr>
	</table>
				...
				foreach ($peluas1 as $key => $rowpeluas1) {
					if(!empty($rowpeluas1['nilai-uts_p']) || !empty($rowpeluas1['nilai-uts_k'])){
						if(!empty($rowpeluas1['nilai-uts_p'])){
							$rowpeluas1['p-np'] = kekata($rowpeluas1['nilai-uts_p']);
						}
						if(!empty($rowpeluas1['nilai-uts_k'])){
							$rowpeluas1['p-nk'] = kekata($rowpeluas1['nilai-uts_k']);
						}
	...
	<?php if ((strpos(strtolower($nama_kelas),'7-')!==false)  or ( strpos(strtolower($nama_kelas),'8-')!==false ) or ( strpos(strtolower($nama_kelas),'9-')!==false )  ) { ?>
	...
	<table border="0" style="width:100%;border: 0px solid black;margin-top: 0.5px;margin-bottom: 0.5px;">
		<tr>
			...
			<td width="30%">
				<p class="text-center">
					Bandung, <?php echo(DateToIndo(date('2017-10-6')));?><br/>
					Wali Kelas
					<br>
					<br>
					<br>
...
<section id="typography" class="break-after" style="margin-top:10px;">		
	...
	<table border="5" style="width:100%;border: 2px solid black;">
		...
		// echo "<pre>";
			...
			if(!empty($peluas1)){
				foreach ($peluas1 as $key => $rowpeluas1) {
					if(!empty($rowpeluas1['nilai-uts_p']) or !empty($rowpeluas1['nilai-uts_k'])){
						if(!empty($rowpeluas1['nilai-uts_p'])){
							if($rowpeluas1['nilai-uts_p']<75){
								$rowpeluas1['p-np'] = "D";
								$peluas1[$key]['p-np'] = "D";
							}elseif($rowpeluas1['nilai-uts_p']>=75 && $rowpeluas1['nilai-uts_p']<84){
								$rowpeluas1['p-np'] = "C";
								$peluas1[$key]['p-np'] = "C";
							}elseif($rowpeluas1['nilai-uts_p']>=84 && $rowpeluas1['nilai-uts_p']<93){
								$rowpeluas1['p-np'] = "B";
								$peluas1[$key]['p-np'] = "B";
							}elseif($rowpeluas1['nilai-uts_p']>=93 && $rowpeluas1['nilai-uts_p']<=100){
								$rowpeluas1['p-np'] = "A";
								$peluas1[$key]['p-np'] = "A";
							}else{
								$rowpeluas1['p-np'] = "-";
						...
						if(!empty($rowpeluas1['nilai-uts_k'])){
							if($rowpeluas1['nilai-uts_k']<75){
								$rowpeluas1['p-nk'] = "D";
								$peluas1[$key]['p-nk'] = "D";
							}elseif($rowpeluas1['nilai-uts_k']>=75 && $rowpeluas1['nilai-uts_k']<84){
								$rowpeluas1['p-nk'] = "C";
								$peluas1[$key]['p-nk'] = "C";
							}elseif($rowpeluas1['nilai-uts_k']>=84 && $rowpeluas1['nilai-uts_k']<93){
								$rowpeluas1['p-nk'] = "B";
								$peluas1[$key]['p-nk'] = "B";
							}elseif($rowpeluas1['nilai-uts_k']>=93 && $rowpeluas1['nilai-uts_k']<=100){
								$rowpeluas1['p-nk'] = "A";
								$peluas1[$key]['p-nk'] = "A";
							}else{
								$rowpeluas1['p-nk'] = "-";
