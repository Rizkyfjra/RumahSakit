					...
					<table border="5" style="width:100%;border: 2px solid black;">
						...
						<tr valign="top">
							<?php if(!empty($peluas2[$z]['Sikap Spiritual - Predikat']) && $peluas2[$z]['Sikap Spiritual - Predikat']!="-") { ?>
								<td height="150px" align="center" valign="middle"><b><?php echo $peluas2[$z]['Sikap Spiritual - Predikat']; ?></b></td>
							<?php }else{ ?>
							...
							<?php if(!empty($peluas2[$z]['Sikap Spiritual - Deskripsi']) && $peluas2[$z]['Sikap Spiritual - Deskripsi']!="-") { ?>
								<td height="150px" valign="middle"><?php echo $peluas2[$z]['Sikap Spiritual - Deskripsi']; ?></td>
							<?php }else{ ?>
								<td height="150px" align="center" valign="middle">-</td>
							<?php } ?>
						</tr>
					...
					<table border="5" style="width:100%;border: 2px solid black;">
						...
						<tr valign="top">
							<?php if(!empty($peluas2[$z]['Sikap Sosial - Predikat']) && $peluas2[$z]['Sikap Sosial - Predikat']!="-") { ?>
								<td height="150px" align="center" valign="middle"><b><?php echo $peluas2[$z]['Sikap Sosial - Predikat']; ?></b></td>
							<?php }else{ ?>
								<td height="150px" align="center" valign="middle">-</td>
							<?php } ?>
							<?php if(!empty($peluas2[$z]['Sikap Sosial - Deskripsi']) && $peluas2[$z]['Sikap Sosial - Deskripsi']!="-") { ?>
								<td height="150px" valign="middle"><?php echo $peluas2[$z]['Sikap Sosial - Deskripsi']; ?></td>
							<?php }else{ ?>
								<td height="150px" align="center" valign="middle">-</td>
							<?php } ?>
						</tr>
							...
							if(!empty($rowpeluas1['nilai-pengetahuan']) && !empty($rowpeluas1['nilai-keterampilan'])){
								if(!empty($rowpeluas1['nilai-pengetahuan'])){
									if($rowpeluas1['nilai-pengetahuan']<75){
										$rowpeluas1['p-np'] = "D";
									}elseif($rowpeluas1['nilai-pengetahuan']==75){
										$rowpeluas1['p-np'] = "C";
									}elseif($rowpeluas1['nilai-pengetahuan']>75 && $rowpeluas1['nilai-pengetahuan']<=85){
										$rowpeluas1['p-np'] = "B";
									}elseif($rowpeluas1['nilai-pengetahuan']>85 && $rowpeluas1['nilai-pengetahuan']<=100){
										$rowpeluas1['p-np'] = "A";
									}else{
										$rowpeluas1['p-np'] = "-";
									}
								...
								if(!empty($rowpeluas1['nilai-keterampilan'])){
									if($rowpeluas1['nilai-keterampilan']<75){
										$rowpeluas1['p-nk'] = "D";
									}elseif($rowpeluas1['nilai-keterampilan']==75){
										$rowpeluas1['p-nk'] = "C";
									}elseif($rowpeluas1['nilai-keterampilan']>75 && $rowpeluas1['nilai-keterampilan']<=85){
										$rowpeluas1['p-nk'] = "B";
									}elseif($rowpeluas1['nilai-keterampilan']>85 && $rowpeluas1['nilai-keterampilan']<=100){
										$rowpeluas1['p-nk'] = "A";
									}else{
										$rowpeluas1['p-nk'] = "-";
									}
				...
				<tr>
					...
					<?php
						if(!empty($peluas2[$z]['Ekstrakurikuler 1 - Nilai']) && $peluas2[$z]['Ekstrakurikuler 1 - Nilai']!="-"){
							...
							if(!empty($peluas2[$z]['Ekstrakurikuler 1 - Deskripsi'])){
			...
			<table border="5" style="width:100%;border: 2px solid black;">
				<tr>
					<?php if(!empty($peluas2[$z]['Catatan Wali Kelas']) && $peluas2[$z]['Catatan Wali Kelas']!="-"){ ?>
						<td height="40px"><?php echo $peluas2[$z]['Catatan Wali Kelas']; ?></td>
					<?php }else{ ?>
						<td height="40px"></td>
					<?php } ?>
				</tr>
