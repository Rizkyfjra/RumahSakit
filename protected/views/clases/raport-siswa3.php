...
?>
<?php if (empty($type)){ ?>
<section id="typography" style="font-size:14px;margin-top:150px;">
<?php } else { ?>
...
<?php } ?>
	<table style="width:100%;">
		<tr>
			...
			<td>Nomor Seri</td>
			<td> : <?php echo $kode_rapot; ?>.<?php echo substr($siswa->username, 0,2)?>10<?php echo substr($siswa->username, -4)?></td>
		</tr>
		<tr >
			<td>NIS</td>
	...
	<p style="font-size:20px;margin-top: 0px;margin-bottom: 4px;"><b>B. Pengetahuan dan Keterampilan</b></p>
	<p style="margin-bottom: 3px;"><b>Kriteria Ketuntasan Minimal = <?php echo $kkm; ?></b></p>
	<table border="5" style="width:100%;border: 2px solid black;">
		
		<tr >
			<th rowspan="3">No</th>
			<th rowspan="3" colspan="1" style="text-align: center;">Mata Pelajaran</th>
		...
		<tr>
			<td colspan="6"><strong>Kelompok C (Peminatan dan Lintas Minat)</strong></td>
		</tr>
	...
	<br>
	<p style="font-size:20px;margin-top: -15px;margin-bottom: -1px;"><b>Predikat :</b></p>
	<table border="5" style="width:30%;border: 2px solid black;margin-top: 5px">
		<tr>
			<th><center><strong>Skala</strong></center></th>
			<th><center><strong>Predikat</strong></center></th>
		</tr>
		<tr>
			<td align="center">86 s.d. 100</td>
			<td align="center">Sangat Baik (A)</td>
		</tr>
		<tr>
			<td align="center">70 s.d. 85</td>
			<td align="center">Baik (B)</td>
		</tr>
		<tr>
			<td align="center">56 s.d. 69</td>
			<td align="center">Cukup (C)</td>
		</tr>
		<tr>
			<td align="center">&lt; 56</td>
			<td align="center">Kurang (D)</td>
		</tr>
	</table>
		...
		<tr>
			...
			<td>
				<p class="text-center" style="font-size:15px;">
					...
					Bandung, <?php echo(DateToIndo(date('Y-m-d')));?>
					<br>Kepala Sekolah,
					<br>
					<br>
					<br>
...
<!-- Halaman 2-->
<?php if (empty($type)){ ?>
<section id="typography" style="font-size:14px;margin-top:150px;display: block; page-break-before: always;" >
<?php } else { ?>
<section id="typography" style="font-size:14px;display: block; page-break-before: always;margin-top:50px;" >
	<br>
<?php } ?>
	...
	<table border="5" style="border-collapse:collapse; table-layout:fixed; width:100%;border: 2px solid black;">
		<tr >
			<th rowspan="3" width="5%">No</th>
			<th rowspan="3" colspan="1" style="text-align: center;" width="40%">Mata Pelajaran</th>
			<th rowspan="2" colspan="1" style="text-align: center;" width="20%">Ranah</th>
			<th rowspan="2" colspan="1" style="text-align: center;">Deskripsi</th>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Kelompok A (Umum)</strong></td>
		</tr>
		...
		if(!empty($mapel1)){
			foreach ($mapel1 as $row1) { ?>
			<tr>
				<td style="text-align: center;" width="3%" rowspan="2"><?php echo $no;?></td>
				<td width="30%" rowspan="2">
						<strong><?php echo $row1->name;?>
					</strong>
				</td>
				<td style="font-size:20px;"><center>Pengetahuan</center></td>
				<td style="font-size:20px;"></td>
			</tr>
			<tr>
				<td style="font-size:20px;"><center>Keterampilan</center></td>
				<td style="font-size:20px; word-wrap:break-word;"></td>
			</tr>
		<?php 
			$no++;
			} 
		...
		<tr>
			<td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Kelompok B (Umum)</strong></td>
		</tr>
		...
		<tr>
			<td colspan="4"><strong>Kelompok C (Peminatan dan Lintas Minat)</strong></td>
		</tr>
	...
	<table border="5" style="width:40%;border: 2px solid black;margin-top: 15px">
		<?php  
			//$absensi=AbsensiImport::model()->findByAttributes(array('user_id'=>$siswa->id,'class_id'=>$siswa->class->id));
		?>
		<tr>
		...
		<tr>
			...
			<td width="3%" style="border: 0;" align="right"><?php //echo ($absensi ? $absensi->sakit : '-') ?> Hari</td>
		</tr>
		<tr>
			<td style="border: 0;">Izin</td>
			<td style="border: 0;">:</td>
			<td style="border: 0;" align="right"><?php //echo ($absensi ? $absensi->izin : '-') ?> Hari</td>
		</tr>
		<tr>
			<td style="border: 0;">Tanpa Keterangan</td>
			<td style="border: 0;">:</td>
			<td style="border: 0;" align="right"><?php //echo ($absensi ? $absensi->alfa : '-') ?> Hari</td>
		</tr>
	</table>
