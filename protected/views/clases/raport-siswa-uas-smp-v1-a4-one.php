...
<section id="typography" class="break-after" style="margin-top:10px;">
	...
	<div >
		<p class="alignleft">
			<img style="margin-bottom: 5px; margin-top: -15px;" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/logo_dh.jpg" width="130px" height="25px"/ >
		</p>
		
			<h4 class="aligncenter" style="margin-bottom: 0px;" >LAPORAN PENCAPAIAN HASIL KOMPETENSI PESERTA DIDIK</h4>
			<h4 class="aligncenter" style="margin-bottom: 0px;" ><?php echo $school_name; ?></h4>
			<h4 class="aligncenter" style="margin-bottom: 0px;" ><?php echo $address; ?></h4>
	...
	<ol type="A" style="margin-bottom: -33px">
		<b><li>
			Sikap
				<br/>
				<b>
					...
					<table border="5" style="width:100%;border: 2px solid black;">
						...
						<tr valign="top">
							...
							<?php if(!empty($peluas2['Sikap Spiritual - Deskripsi']) && $peluas2['Sikap Spiritual - Deskripsi']!="-") { ?>
								...
								if ((substr($spiritualDesc, -1) == ".") or (substr($spiritualDesc, -2) == ".")){
									echo $spiritualDesc; 
								}	else {
									echo $spiritualDesc."."; 
								}	
					...
					<table border="5" style="width:100%;border: 2px solid black;">
						...
						<tr valign="top">
							...
							<?php if(!empty($peluas2['Sikap Sosial - Deskripsi']) && $peluas2['Sikap Sosial - Deskripsi']!="-") { ?>
								...
								$sosialDesc = str_replace('.  ','. ',$sosialDesc);
								$sosialDesc = str_replace('. . ','. ',$sosialDesc);
								$sosialDesc = $sosialDesc.".";
								$sosialDesc = str_replace('. .','.',$sosialDesc);


								// if ((substr($sosialDesc, -1) == ".") or (substr($sosialDesc, -2) == ".")){
									echo $sosialDesc; 
								// }	else {
								// 	echo $sosialDesc."."; 
								// }	
			...
			<table border="0" style="width:100%;border: 0px solid black;margin-top: 0.5px;margin-bottom: 0.5px;">
				<tr>
					...
					if(Yii::app()->session['titimangsa']){
						...
						if ($optSchoolType=="SMP NEGERI 43 BANDUNG") {
							echo(DateToIndo(date('2019-06-21')));
						}	else {
							echo(DateToIndo(date('2019-06-21')));
						}
						// echo(DateToIndo(date('2019-06-21')));
