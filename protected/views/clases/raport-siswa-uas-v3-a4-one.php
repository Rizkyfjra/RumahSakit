		...
		<tr valign="top">
			...
			<?php if(!empty($peluas2['Sikap Spiritual - Deskripsi']) && $peluas2['Sikap Spiritual - Deskripsi']!="-") { ?>
				<?php if($peluas2['Sikap Spiritual - Predikat']  == "A" || $peluas2['Sikap Spiritual - Predikat']  == "SB" ) { ?>
					<td height="150px" valign="middle"><?php echo $peluas2['Sikap Spiritual - Deskripsi']." dengan sangat baik."; ?></td>
				<?php } else if($peluas2['Sikap Spiritual - Predikat']  == "B") { ?>
					<td height="150px" valign="middle"><?php echo $peluas2['Sikap Spiritual - Deskripsi']." dengan baik."; ?></td>
				<?php } else { ?>
					<td height="150px" valign="middle"><?php echo $peluas2['Sikap Spiritual - Deskripsi']." dengan cukup baik."; ?></td>
				<?php }?>
			<?php }else{ ?>
								<?php if(!empty($peluas2['Sikap Spiritual - Predikat'])) { ?>
									...
									<?php } else {?>
									<td height="150px" valign="middle">Kebiasaan berdoa dan memberi salam sebelum dan sesudah melakukan kegiatan pembelajaran, menghormati orang lain dalam melaksanakan ibadah telah dilaksanakan dengan cukup baik.</td>
									<?php } ?>
								<?php } else {?>
		...
		<tr valign="top">
			...
			<?php if(!empty($peluas2['Sikap Sosial - Deskripsi']) && $peluas2['Sikap Sosial - Deskripsi']!="-") { ?>
				<?php if($peluas2['Sikap Sosial - Predikat']  == "A" || $peluas2['Sikap Sosial - Predikat']  == "SB" ) { ?>
					<td height="150px" valign="middle"><?php echo $peluas2['Sikap Sosial - Deskripsi']." dengan sangat baik."; ?></td>
				<?php } else if($peluas2['Sikap Sosial - Predikat']  == "B") { ?>
					<td height="150px" valign="middle"><?php echo $peluas2['Sikap Sosial - Deskripsi']." dengan baik."; ?></td>
				<?php } else { ?>
					<td height="150px" valign="middle"><?php echo $peluas2['Sikap Sosial - Deskripsi']." dengan cukup baik."; ?></td>
				<?php } ?>
			<?php }else{ ?>
								<?php if(!empty($peluas2['Sikap Sosial - Predikat'])) { ?>
									...
									<?php } else { ?>
									<td height="150px" valign="middle">Memiliki sikap perilaku jujur, disiplin dalam belajar, peduli terhadap teman, santun dalam ucapan dan tidakan, responsif, pro-aktif dan penunjukan sikap dengan cukup baik.</td>
									<?php } ?>
								<?php } else {?>
								<td height="150px" valign="middle">-</td>
								<?php }?>
				...
				foreach ($peluas1 as $key => $rowpeluas1) {
					if(!empty($rowpeluas1['nilai-pengetahuan']) && !empty($rowpeluas1['nilai-keterampilan'])){
						if(!empty($rowpeluas1['nilai-pengetahuan'])){
							// if($rowpeluas1['nilai-pengetahuan']<80){
							// 	$rowpeluas1['p-np'] = "D";
							// 	$peluas1[$key]['p-np'] = "D";
							// }elseif($rowpeluas1['nilai-pengetahuan']>=80 && $rowpeluas1['nilai-pengetahuan']<82){
							// 	$rowpeluas1['p-np'] = "C";
							// 	$peluas1[$key]['p-np'] = "C";
							// }elseif($rowpeluas1['nilai-pengetahuan']>=82 && $rowpeluas1['nilai-pengetahuan']<91){
							// 	$rowpeluas1['p-np'] = "B";
							// 	$peluas1[$key]['p-np'] = "B";
							// }elseif($rowpeluas1['nilai-pengetahuan']>=91 && $rowpeluas1['nilai-pengetahuan']<=100){
							// 	$rowpeluas1['p-np'] = "A";
							// 	$peluas1[$key]['p-np'] = "A";
							// }else{
							// 	$rowpeluas1['p-np'] = "-";
							...
							$peluas1[$key]['p-np'] = Clases::model()->predikat($rowpeluas1['nilai-pengetahuan'],$kkm); 

						}
						if(!empty($rowpeluas1['nilai-keterampilan'])){
							// if($rowpeluas1['nilai-keterampilan']<80){
							// 	$rowpeluas1['p-nk'] = "D";
							// 	$peluas1[$key]['p-nk'] = "D";
							// }elseif($rowpeluas1['nilai-keterampilan']>=80 && $rowpeluas1['nilai-keterampilan']<82){
							// 	$rowpeluas1['p-nk'] = "C";
							// 	$peluas1[$key]['p-nk'] = "C";
							// }elseif($rowpeluas1['nilai-keterampilan']>=82 && $rowpeluas1['nilai-keterampilan']<91){
							// 	$rowpeluas1['p-nk'] = "B";
							// 	$peluas1[$key]['p-nk'] = "B";
							// }elseif($rowpeluas1['nilai-keterampilan']>=91 && $rowpeluas1['nilai-keterampilan']<=100){
							// 	$rowpeluas1['p-nk'] = "A";
							// 	$peluas1[$key]['p-nk'] = "A";
							// }else{
							// 	$rowpeluas1['p-nk'] = "-";
							// 	$peluas1[$key]['p-nk'] = "-";
							// }
							$peluas1[$key]['p-nk'] = Clases::model()->predikat($rowpeluas1['nilai-keterampilan'],$kkm); 
			...
			<?php }else{ ?>
				...
				<td align="left">
					...
					if (!empty($rowpeluas1['p-np']) && $rowpeluas1['p-np']=="A") {
						echo "Memahami pengetahuan tentang  ".implode(", ", $rowpeluas1['nilai-kddescription'])." dengan sangat baik";
					} else if(!empty($rowpeluas1['p-np']) && $rowpeluas1['p-np']=="B"){
						echo "Memahami pengetahuan tentang  ".implode(", ", $rowpeluas1['nilai-kddescription'])." dengan baik";
					} else if(!empty($rowpeluas1['p-np']) && $rowpeluas1['p-np']=="C"){
						echo "Memahami pengetahuan tentang  ".implode(", ", $rowpeluas1['nilai-kddescription'])." dengan cukup baik";
					} else if(!empty($rowpeluas1['p-np']) && $rowpeluas1['p-np']=="D"){
						echo "Memahami pengetahuan tentang  ".implode(", ", $rowpeluas1['nilai-kddescription'])." perlu ditingkatkan";
					}?>
				</td>
				<?php } else { ?>
				<td align="left"><?php 
			...
			<?php }else{ ?>
				...
				<td align="left">
					...
					if (!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="A") {
						echo "Sangat terampil dalam mempraktikan materi ".implode(", ", $rowpeluas1['nilai-kddescription-ket'])."";
					} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="B"){
						echo "Terampil dalam mempraktikan materi ".implode(", ", $rowpeluas1['nilai-kddescription-ket'])."";
					} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="C"){
						echo "Cukup terampil dalam mempraktikan materi ".implode(", ", $rowpeluas1['nilai-kddescription-ket'])."";
					} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="D"){
						echo "Kurang terampil dalam mempraktikan materi ".implode(", ", $rowpeluas1['nilai-kddescription-ket'])."";
					}?>
				</td>
				<?php } else {?>
				<td align="left"><?php 
					if (!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="A") {
						echo "Sangat terampil dalam mempraktikan semua materi";
					} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="B"){
						echo "Terampil dalam mempraktikan semua materi";
					} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="C"){
						echo "Cukup terampil dalam mempraktikan semua materi";
					} else if(!empty($rowpeluas1['p-nk']) && $rowpeluas1['p-nk']=="D"){
						echo "Kurang terampil dalam mempraktikan semua materi";
					}?></td>
				<?php }?>
			<?php } ?>
		</tr>
	...
	<table border="0" style="width:100%;border: 0px solid black;margin-top: 0.5px;margin-bottom: 0.5px;">
			...
			<td width="50%">
				<p class="text-center">
					...
					if(Yii::app()->session['titimangsa']){
						...
						echo(DateToIndo(date('2017-12-15')));
					}
					?><br/>
					Wali Kelas
					<br>
		...
		<tr>
			<td width="100%" colspan="2">
				<p class="text-center">
					<span style=" z-index: 0; position:relative;">Kepala Sekolah</span>
					<?php if ($optSchoolType == "SMA NEGERI 1 BANDUNG" ) {?>
					<br/>
					<img style="width: 20%; margin-bottom: -41px; margin-top: -11px;" src="../../images/ttdkepsek.png"/>
					<br/>
					<?php } else {?>
					<br/>
					<br/>
